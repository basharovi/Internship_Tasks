...
namespace WpfAppFirstCodingTest
{
    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        private void CreatePdf(string path)
        {
            ...
            BarcodeQRCode Qr = new BarcodeQRCode("hossain, tonnoy bhai , jeasan bhai , Asad bhai , Farhan bhai", 60, 6, null);
           ...
           // cb.SetTextMatrix(-2.0f, 0.0f);
            ...
            try
            {
                ...
                PdfPCell QRcode = new PdfPCell(new Phrase(new Chunk(img, 0, 0, true)))
                {
                ...
                cell = new PdfPCell(new Phrase("Enter The Server Name:"));
                cell.Border = Rectangle.NO_BORDER;
                cell.PaddingTop = 20;
                cell.FixedHeight = 45;
                table.AddCell(cell);
